...
combineString(str1: nil, str2: "CD", str3: "EF")
...
enum Temperature {
    ...
    func toCelcius()->Double{
        switch self {
        case .celcius(let x): return x
        case .fahrenheit(let x): return (x - 32) * 5 / 9
        case .kelvinv(let x): return x + 273
        }
    }
}

var duck1: Temperature = .fahrenheit(43)
print(duck1.toCelcius())
